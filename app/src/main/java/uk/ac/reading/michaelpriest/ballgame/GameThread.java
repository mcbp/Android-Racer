...
public abstract class GameThread extends Thread {
	...
	protected Background mBackgroundImage;
	...
	public GameThread(GameView gameView) {		
		...
		mBackgroundImage = new Background(BitmapFactory.decodeResource
							(gameView.getContext().getResources(), 
							R.drawable.background_brown));
        mBackgroundImage.setVector(moveSpeed);
	...
	public void setSurfaceSize(int width, int height) {
		synchronized (monitor) {
            ...
            mBackgroundImage.scale(width, height);
		}
	}
	...
	private void updatePhysics() {
		...
		updateGame(elapsed, mBackgroundImage);

		mLastTime = now;
	}
	
	abstract protected void updateGame(float secondsElapsed, Background bg);
	...
	public boolean onTouch(MotionEvent e) {
		...
		synchronized (monitor) {
				this.actionOnTouch(e.getRawX(), e.getRawY(), e);
		}
		 
		return false;
	}
	
	protected void actionOnTouch(float x, float y, MotionEvent event) {
